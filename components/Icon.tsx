...
type IconName = 'leaf' | 'dashboard' | 'scan' | 'history' | 'book' | 'community' | 'upload' | 'arrowRight' | 'spray' | 'fertilizer' | 'scissors' | 'rotate' | 'shield' | 'water' | 'healthy' | 'warning' | 'chatbot' | 'settings' | 'globe';
