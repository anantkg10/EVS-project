...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-cover bg-center bg-fixed text-gray-200" style={{ backgroundImage: "url('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQiGZh83W1zwvh5FI4F0fXaAECRZKZKYP4IxA&s')" }}>
